...
export function ChatComposer({
  ...
  return (
    <div className="flex w-full flex-col">
      {/* One continuous Meet-style capsule: clicking the sparkles icon grows
          this same shape upward to reveal the filters, rather than popping a
          separate row in above it — the rounded corners/border/background
          stay on this outer wrapper the whole time. */}
      <div
        className={cn(
          "group relative flex flex-col overflow-hidden rounded-[28px] sm:rounded-[32px] border transition-all duration-200",
      ...
      >
        ...
        <div className="flex items-end gap-3 px-4 py-3 sm:px-5 sm:py-3.5">
          <Button
            type="button"
            variant="ghost"
            size="icon"
