  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:text-foreground dark:data-active:border-transparent dark:data-active:bg-primary/30 dark:data-active:text-foreground/80",
